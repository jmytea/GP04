...
// 3.判断是登录还是注册
if ($type === 'login') {
   $login_sql = "select * from usermsg where username='$username' and pwd='$pwd'";
...
if ($type === 'add') {
    $add_sql = "select * from usermsg where username='$username'";
    ...
    $insert_sql = "insert into usermsg(username,pwd) values('$username','$pwd')";
